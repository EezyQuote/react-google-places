...
type FetchSuggestionsCallback =  (options: OptionsType<OptionTypeBase>) => void
...
const GooglePlacesAutocomplete: React.FC<GooglePlacesAutocompleteProps> = ({
  ...
  return (
    <AsyncSelect
      {...selectProps}
      // allowed because useDebouncedCallback hook creates incoherent typing for loadOptions
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      loadOptions={fetchSuggestions as any}
